...
PANES = ["connect", "embed", "options", "about", "privacypolicy", "feedback", "faq", "wiki_irc"]
UI_BASE = ["lang","menuitems", "crans", "baseui", "baseuiwindow", "colour", "url", "theme", "notifications", "tabcompleter", "style"]
