...
IRCSERVER, IRCPORT = "irc.crans.org", 6667
...
BASE_URL = "http://irc.crans.org/web/"
...
FEEDBACK_FROM = "irc@crans.org"

# OPTION: FEEDBACK_TO:
#         E-mail address that feedback will be sent to.
FEEDBACK_TO = "nounous@crans.org"
...
ARGS = "--syslog --syslog-prefix=qwebirc"
ARGS += " --ip 127.0.0.1 -p 9090"   #Listen on local only
